...
class FilmsPage extends StatelessWidget {
                                  ...
                                  onPressed: isLoading
                                      ...
                                      : () async {
                                          if (_formKey.currentState!
                                            ...
                                            // Ajoute ici la logique pour ajouter le film à ta liste
                                          }
                                        },
                                  child: isLoading
                                      ? const SizedBox(
  ...
  Widget build(BuildContext context) {
    ...
    final List<Info> filmInfos =
        films.map((film) => Info.fromContentDetails(film)).toList();
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage(filmInfos[0].bgImage),
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            InkWell(
                              borderRadius: BorderRadius.circular(16),
                              onTap: () => _showAddFilmDialog(context),
                              child: Container(
            ...
            child: Column(
              ...
              children: [
                _buildContentSection(
                  '🔥 Tendance',
                  filmInfos.sublist(1, 11),
                  themeProvider,
                  context,
                ),
                _buildContentSection(
                  '🆕 Nouveautés',
                  filmInfos.sublist(11, 21),
                  themeProvider,
                  context,
                ),
                _buildContentSection(
                  '🎬 Films d\'action',
                  filmInfos.sublist(21, 31),
                  themeProvider,
                  context,
                ),
                _buildContentSection(
                  '⭐ Films populaires',
                  filmInfos.sublist(31, 41),
                  themeProvider,
                  context,
                ),
              ],
        ...
        SizedBox(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return _FilmCard(item: item, themeProvider: themeProvider);
            },
          ),
        ),
      ],
...
class _FilmCard extends StatefulWidget {
  ...
  const _FilmCard({required this.item, required this.themeProvider, Key? key})
      : super(key: key);
